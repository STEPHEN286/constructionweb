...
export default function Card() {
  return (
    <div className=" shadow relative p-3  lg:px-15   md:bg-white w-full     h-fit pb-10 ">
        ...
        <p className="text-gray-400 text-[12px] leading-5   lg:w-64 ">Elevate your space with our expert interior renovation services. From design to execution, we
