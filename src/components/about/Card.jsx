...
export default function Card() {
  return (
    <div className=" shadow relative pl-10 bg-white  w-full  h-fit pb-10 ">
        ...
        <p className="text-gray-400 text-[12px] lin">Elevate your space with our expert interior renovation services. From design to execution, we
        ensure every detail is tailored to your needs.</p>
        <span className="h-0.5 w-full  bg-gray-200 flex justify-end">
