...
export default function ProjectSection() {
  return (
    <div className="w-full min-h-[450px] md:h-[450px] grid grid-cols-1 md:grid-cols-7">
      {/* Left Section */}
      <div className="bg-[#333] md:col-span-3 relative px-5 md:px-20 flex items-center">
        <LeftContainer />
