...
export default function MaterialCounters() {
  return (
    <div className="h-15 w-full bg-gray-800 grid overflow-hidden  grid-cols-3 z-20 ">
      ...
      <div className=" relative h-full flex justify-center items-center gap-10  bg-gray-700 col-span-1 
      before:absolute before:left-0  beofore:transform beofore:-translate-y-1/2 before:h-1/3 before:w-[2px] before:bg-amber-400  overflow-hidden">
        <button>
          <ArrowLongLeftIcon className="h-6 w-6  text-amber-300" />
        </button>
        <button>
          <ArrowLongRightIcon className="h-6 w-6  text-amber-300" />
        </button>
      </div>
    </div>
  );
